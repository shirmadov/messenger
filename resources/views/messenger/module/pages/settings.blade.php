...
{{--                @if(!is_null(\Auth()->user()->profile->avatar)) style="visibility: hidden" @endif--}}
                <svg xmlns="http://www.w3.org/2000/svg" width="36" height="41" viewBox="0 0 36 41" fill="none">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                          ...
                          fill="#ffffff"/>
                    <line x1="0.999591" y1="6.00408" x2="10.9996" y2="5.99999" stroke="#ffffff" stroke-width="2"
                          stroke-linecap="round"/>
                    <line x1="6" y1="1" x2="6" y2="11" stroke="#ffffff" stroke-width="2" stroke-linecap="round"/>
                </svg>
            </div>
            <input class="js__profile__img" hidden type="file" name="profile_file">
        </div>

        <div class="page__st__profile__form">
            <div class="profile__form">
                <label class="profile__form__label" for="fullname">Full Name</label><br>
                <input type="text" name="fullname" readonly class="profile__form__input js__profile__form__input" id="fullname" value="{{\Auth()->user()->name}}">
            ...
            <div class="profile__form">
                ...
                <input type="text" name="username" readonly class="profile__form__input js__profile__form__input" id="username" value="{{\Auth()->user()->username}}">
                <span class="profile__form__underline js__profile__form__underline"></span>
            </div>
        </div>
    </div>
    ...
    <div class="page__st">
        <ul class="page__st__list__ul">
            <li class="page__st__list__li" onClick="slide('next',1)">
            ...
            <li class="page__st__list__li" onClick="slide('next',2)">
                <div class="page__st__list__icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none">
            ...
            <li class="page__st__list__li" onClick="slide('next',3)">
                <div class="page__st__list__icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none">
            ...
            <li class="page__st__list__li" onClick="slide('next',4)">
                <div class="page__st__list__icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none">
            ...
            <li class="page__st__list__li" onClick="slide('next',5)">
                <div class="page__st__list__icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none">
