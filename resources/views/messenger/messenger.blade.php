   ...
   <div class="modal">
    ...
    <div class="drop__crop">
        ...
        <div class="drop__crop__card">
            <img class="drop__crop__img js__drop__crop__img" id="js__drop__crop__img" src="https://p1.pxfuel.com/preview/274/652/884/flag-marine-turkey.jpg" alt="Picture">
{{--            <div class="preview"></div>--}}
            <div class="drop__crop__done__icon" id="js__drop__crop__done__icon">
