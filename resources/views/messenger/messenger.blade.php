    ...
    <div class="container">
            ...
            <div class="left__card js__left__card" >
                <div class="pages">
                    ...
                    <div class="layer">
                        @include('messenger.module.pages.settings_module.notification')
                        @include('messenger.module.pages.settings_module.data_and_storage')
                        @include('messenger.module.pages.settings_module.privacy_and_security')
                        @include('messenger.module.pages.settings_module.general_settings')
                        @include('messenger.module.pages.settings_module.wallpaper')
                    </div>
